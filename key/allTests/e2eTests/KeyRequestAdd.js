module.exports = {
    ...
    'opening key request add form': function (browser) {
        browser
            .maximizeWindow()
            .url('http://127.0.0.1:8081/#/keys')
            .waitForElementVisible('button[ng-click="openKeyRequestAddModal()"]', 2000)
            .click('button[ng-click="openKeyRequestAddModal()"]')
    },
    'testing key request add form': function (browser) {
        browser
