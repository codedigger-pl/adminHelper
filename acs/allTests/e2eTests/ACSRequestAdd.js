module.exports = {
    ...
    'opening ACS request add form': function (browser) {
        browser
            .maximizeWindow()
            .url('http://127.0.0.1:8081/#/acs')
            .waitForElementVisible('button[ng-click="openACSRequestAddModal()"]', 2000)
            .click('button[ng-click="openACSRequestAddModal()"]')
    },
    'testing ACS request add form': function (browser) {
        browser
