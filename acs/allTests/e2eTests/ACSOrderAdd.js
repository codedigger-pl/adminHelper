module.exports = {
    ...
    'opening ACS order add form': function (browser) {
        browser
            .maximizeWindow()
            .url('http://127.0.0.1:8081/#/acs')
            .waitForElementVisible('button[ng-click="openACSOrderAddModal()"]', 2000)
            .click('button[ng-click="openACSOrderAddModal()"]')
    },
    'testing ACS order add form': function (browser) {
        browser
